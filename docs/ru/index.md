...
features:
  - title: Оригинальные протоколы
    icon: 📄
    details: Оригинальные протоколы VLESS, XTLS, XUDP, XHTTP, REALITY и другие охватывают проксирование, управление потоком, мультиплексирование, транспорт и безопасность.
  - title: Мощная маршрутизация
    icon: 🔀
    details: Гибкая система маршрутизации и DNS поддерживает тонкую настройку трафика по доменам, IP, портам, протоколам, процессам, пользователям и другим условиям.
...
- [Группа обсуждения Project X](https://t.me/projectXray)
  - Группа для пользователей на китайском и английском языках. Основная группа общения.
...
- Проект X теперь выпускает NFT! Если вы хотите получить NFT Project X, либо пожертвовать или спонсировать Project X, нажмите [здесь](https://github.com/XTLS/Xray-core/discussions/3633)
