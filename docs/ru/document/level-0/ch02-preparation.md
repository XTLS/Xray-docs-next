...
1. Установить на VPS текущую стабильную версию Debian 64-bit. На момент этой правки это Debian 13 / trixie.
...
::: tip Пояснение
Несколько слов о выборе стабильной версии Debian в качестве операционной системы. Что бы вы ни слышали в интернете, какой бы дистрибутив Linux ни советовали вам гуру, все эти споры о том, какой Linux лучше, **не имеют к вам никакого отношения**! Текущая стабильная версия Debian уже достаточно надёжна, стабильна и оптимизирована для VPS (например, содержит специальное ядро для облачных сред и своевременную поддержку `BBR`). Когда вы освоитесь с Linux, можете попробовать и другие дистрибутивы.
:::
