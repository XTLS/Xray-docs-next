...
Настройки MASQUE для потока данных. Действуют только когда `method` равно `masque`.
...
Поддерживается использование вместе с транспортами `RAW`, `XHTTP`, `mKCP`, `gRPC`, `WebSocket`, `HTTPUpgrade`, `Hysteria` и `MASQUE`.
...
| --------------------------------------------------------------------- | -------------- | -------------- | -------------- | -------------- | -------------- | -------------- | -------------- | -------------- |
| `http`                                                                | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Неприменимо    |
| `socks` <sup><a href="#protocol-transport-note-1">[1]</a></sup>       | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Неприменимо    |
| `shadowsocks` <sup><a href="#protocol-transport-note-1">[1]</a></sup> | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Ограниченно    | Неприменимо    |
| `vmess`                                                               | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Неприменимо    |
| `vless`                                                               | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Неприменимо    |
| `trojan`                                                              | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Поддерживается | Неприменимо    |
| `hysteria`                                                            | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Поддерживается | Неприменимо    |
| `wireguard`                                                           | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    |
| `masque`                                                              | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Неприменимо    | Поддерживается |
...
| `masque`      | Не поддерживается | Обязательно    | Не поддерживается |
...
| `masque`      | Не поддерживается                                                  | Обязательно                                                        | Не поддерживается                                                  | Нет (зависит от TLS)                                                                                             |
