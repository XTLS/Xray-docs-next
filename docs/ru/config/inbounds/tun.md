...
На Android TUN FD должен передаваться внешним приложением; он не может запускаться самостоятельно и служит лишь способом для приложения передавать трафик в Xray.
