...
Задаёт переменные окружения процесса после разбора конфигурации. Может настраивать runtime-параметры Xray и переменные, которые Go или другие зависимости читают позднее.
