...
::: warning Избегайте зацикливания

Не допускайте, чтобы правила или балансировщик после возврата снова выбирали исходный outbound, иначе может образоваться цикл `outbound -> Loopback -> routing -> исходный outbound`.
